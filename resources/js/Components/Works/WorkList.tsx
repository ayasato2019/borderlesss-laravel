	...
	const links = [
		{
			...
			serverUplode: true,
			aftercare: true,
			comment: 'デザインからご依頼いただきました。\n情報へアクセスしやすいサイトを目指しました。\nGoogleのMymap機能を使い、地元周辺の工事実績を登録することで、地元のインフラに貢献しているとわかるように工夫しています。',
		},
		{
				...
				{links.map((link, index) => (
					<li key={index} className='w-full md:w-1/2'>
						<a href={link.url} className='flex flex-col p-4'>
							...
							<div className='flex flex-col lg:flex-row gap-10 justify-center items-center p-5 bg-[rgba(226,232,240,0.7)]'>
