    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="w-2/3 mx-auto">
                ...
                <p className="my-10 w-auto mx-auto text-center">フリーランスのフロントエンドエンジニアです。<br />Webデザインもご相談ください。<br />Photoshopを使った合成写真も得意です。Illustratoreを使ってバナーやアイコンを作ることもできます。趣味でPOPダンスをやっています。<br />趣味でも仕事でも、意気投合しそうならXをフォローしてください。</p>
            </div>
        </div>
    );
}
