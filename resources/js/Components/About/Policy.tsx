export default function Policy() {
	...
	return (
		<div className="container mx-auto px-4 py-8 flex flex-row items-center justify-center flex-wrap h-full">
			...
			<canvas id="canvas-policy" className="w-full md:w-1/2 h-full"></canvas>
		</div>
	);
}
