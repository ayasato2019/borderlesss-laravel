    ...
    <header className="header">
      <div className="relative selection:bg-rose-700 selection:text-amber-500 pl-2 pr-4 py-4 flex justify-between items-center flex-wrap w-full lg:items-start lg:flex-row lg:flex-nowrap lg:justify-between mix-blend-difference">
        ...
        >
          ...
          <ul
            className="w-auto flex flex-col flex-wrap lg:flex-row lg:justify-center lg:items-center gap-4 lg:gap-0 list-[''] mx-auto lg:mx-0"
            role="menu"
          >
            ...
            <li className="w-auto h-auto lg:w-1/5">
              <Link
                href="/contact/"
                className="header-nav-link contact"
                tabIndex={isMenuOpen ? 0 : -1}
              >
                CONTACT
              </Link>
            ...
            <li className="w-full">
              <Link
                href="/privacy-policy/"
                className="flex p-4 lg:p-0 text-slate-500 font-en cursor-pointer ease-out break-keep h-full lg:h-auto justify-center lg:justify-start text-xs w-full lg:w-auto lg:absolute lg:top-[-24px] lg:right-28"
                tabIndex={isMenuOpen ? 0 : -1}
              >
                Privacy Policy
              </Link>
            </li>
            <SnsLinks tabIndex={isMenuOpen ? 0 : -1} />
          </ul>
        </nav>
      </div>
    </header>
