    ...
    return (
        <>
            ...
            <div className="wrapper relative max-w-7xl mx-auto w-full h-auto min-h-screen">
                ...
                <div className="overflow-hidde w-full max-w-full">
                    ...
                    <footer className="box-border w-screen mx-[calc(50%-50vw)] px-[calc(50vw-50%)] bg-slate-500 text-white py-5">
                        <div className="container box-border mx-auto px-4">
